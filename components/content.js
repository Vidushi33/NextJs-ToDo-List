    ...
    <>
      <div className="my-12 max-w-6xl  mx-auto  grid  lg:grid-cols-4 gap-8 md:grid-cols-3 sm:grid-cols-2   justify-center ">
        {tasks.map((task) => (
          <div
            key={task._id}
            className=" max-w-xs bg-sky-200 p-3 rounded border-solid border-t-4 border-cyan-950 "
          >
            <div className="">
              <h1 className="bg-cyan-950 text-white max-w-2xl w-fit py-1 px-5 font-bold rounded text-center">
                {task.title}
              </h1>
